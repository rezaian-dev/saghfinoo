      ...
      <div className="contact-info__content">
        ...
        <div className="contact-info__social">
          <a href="https://web.whatsapp.com/" target="_blank" rel="noopener noreferrer">
            <Whatsapp className="contact-info__icon" color="#CB1B1B" variant="Bold" />
          </a>
          <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
            <Instagram className="contact-info__icon" color="#CB1B1B" variant="Bold" />
          </a>
        </div>
        ...
        <a className="contact-info__call-button" href="tel:02141067000">
          ...
          <Call className="contact-info__call-icon" color="#FFFFFF" variant="Outline" />
        </a>
      </div>
    </div>
  );
