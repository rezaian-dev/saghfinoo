...
const VerificationCodeStepMobile = memo(({
  ...
  return (
    <div>    
      ...
      <h5 className="verification-step__title">
        کد تایید
      </h5>
      ...
      <form onSubmit={handleSubmit(onSubmitVerification)} className="mt-8">
        ...
        <div className="verification-step__resend-container">
          {state.isResendActive ? (
            ...
            <>
              ...
              {/* 👁️ User's OTP code */}
              <span
                className={clsx("verification-step__user-code", state.showCodeUser && "verification-step__user-code--visiable")}>
        ...
        <div className="my-9">
          <button
            ...
            className={clsx("verification-step__submit-btn",
              state.otp.length === 5 && !state.otpError ? "bg-primary": "bg-tint-4")}>
            تایید
          </button>
        </div>
      </form>
