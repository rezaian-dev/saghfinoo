...
export default function HousingScout() {
 const dataCart=[
  {id:1, img:"images/landing/residential-house.webp",alt:"ResidentialHouse",price:28.900, caption:"خانه مسکونی"},
  {id:2, img:"images/landing/apartment-tower.webp",alt:"ApartmentTower",price:309.798, caption:"آپارتمان و برج"},
  {id:3, img:"images/landing/luxury-villa.webp",alt:"LuxuryVilla",price:946, caption:"ویلا"},
  {id:4, img:"images/landing/commercial-office.webp",alt:"CommercialOffice",price:27.339, caption:"تجاری و اداری"},
]
  return (
    <>
